...
$id=  filter_input(INPUT_GET, 'id',FILTER_SANITIZE_NUMBER_INT);
                    $select_edite = "select * from usuarios where idUsuario='$id'";
...
<div id="formulario-cadastro">
    <form role="form" class="cadastro" action="php/editarUser.php" id="form-cadastro" method="post">
    
       <input type="hidden" name="id" value="<?php echo $linhas ['idUsuario'];?>">
      <div class="form-row">
        <div class="col-md">
            <div class="form-group">
                <label for="primeiro-nome">Primeiro nome<strong class="text-danger"> *</strong></label>
                <input type="text" class="form-control validar" name="primeiro-nome"  oninput="validaroninput(this.id,'p-primeiro-nome','l-primeiro-nome')" 
                       value="<?php echo $linhas['nome'];?>" id="primeiro-nome" placeholder="primeiro nome" autocomplete="off" maxlength="15" required pattern="[A-Za-z]*">
        ...
        <div class="col-md">
            <div class="form-group">
                ...
                <input type="text" class="form-control validar" name="apelido" oninput="validaroninput(this.id,'p-apelido','l-apelido')"
                       value="<?php echo $linhas['apelido'];?>" id="apelido" placeholder="apelido" required autocomplete="off" maxlength="15" pattern="[A-Za-z]*">
        ...
        <div class="col-md">
            <div class="form-group" style="">
                ...
                <input type="password" class="form-control validar" name="senha" oninput="validaroninput(this.id,'p-senha','l-senha')" 
                       value="<?php echo $linhas['senha'];?>" id="senha" placeholder="Palavra-Pass" required autocomplete="off" minlength="9" maxlength="15">
    ...
    <div class="form-row">
        <div class="col-md">
            <div class="form-group" style="">
                ...
                <input type="tel" class="form-control validar" name="numero-telefone" oninput="validaroninput(this.id,'p-numero-telefone','l-numero-telefone')" 
                       value="<?php echo $linhas['nrcelular'];?>"  id="numero-telefone" placeholder="número de telefone" required autocomplete="off" pattern="^8[2-7]{1}[0-9]{7}">
        ...
        <div class="col-md">
            <div class="form-group" style="">
                ...
                <input type="email" class="form-control validar" name="email" oninput="validaroninput(this.id,'p-email','l-email')" 
                       value="<?php echo $linhas['email'];?>" id="email" placeholder="exemplo@email.com " maxlength="50" autocomplete="off" pattern="^[A-Za-z]([A-Za-z0-9._]*)@([A-Za-z]*)\.+([A-Za-z.])*[A-Za-z]{2,10}$">
    ...
    <div class="form-row">
        <div class="col-md">
            <div class="form-group" style="">
                ...
                <input type="text" class="form-control validar" name="numero-bi" oninput="validaroninput(this.id,'p-numero-bi','l-numero-bi')" 
                       value="<?php echo $linhas['bi'];?>" id="numero-bi" placeholder="número de bi" required autocomplete="off" pattern="[0-9]{12}[A-Za-z]{1}$">
        ...
        <div class="col-md">
            <div class="form-group" style="">
                ...
                <input type="text" class="form-control validar" name="codigo-funcionario" oninput="validaroninput(this.id,'p-codigo-funcionario','l-codigo-funcionario')" 
                       value="<?php echo $linhas['nrFuncionario'];?>" id="codigo-funcionario" placeholder="código do funcionário" min="700000" required autocomplete="off">
    ...
    <div class="form-row">
        <div class="col-md">
            <div class="form-group" style="">
                ...
                <select class="form-control validar custom-select d-block" name="nivelAcesso" oninput="validaroninput(this.id,'p-nivel-acesso','l-nivel-acesso')" name="nivel-acesso" id="nivel-acesso" required>
                    ...
                    <option value="armazem" id="responsavel-armazem">Responsável do armazém</option>
                </select>
        ...
        <div class="col-md-3">
            <div class="form-group" style="padding:0px;margin: 0px;">
                <input type="submit" value="Actualizar"  onclick="validarOnclick()" class="btn btn-success btn-block" name="btn-actualizar" id="btn-atualizar">
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group" style="padding:0px;margin: 0px;">
