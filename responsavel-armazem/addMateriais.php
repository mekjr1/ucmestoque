                ...
                <main role="main" class="col-md-10 ml-auto col-xl-10 col-lg-10">
                    ...
                    <section class="mx-4 pt-4">
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                            <h1 class="h2 animated wobble">Adicionar materiais</h1>
                        </div>
                        ...
                        <div id="formulario-adicionar-materiais">
                            <form role="form" class="needs-validation cadastro animated bounceIn" novalidate action="php/Cadmaterial.php" method="post">
                                <div class="form-row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="nomeMaterial">Nome do Material <strong class="text-danger">*</strong></label>
                                            <input type="text" class="form-control" name="nomeMaterial" value="" id="nomeMaterial" placeholder="Nome do Material" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group" style="">
                                           ...
                                           <select  class="form-control validar custom-select" style="border-top-right-radius:0px;  border-bottom-right-radius:0px;" oninput="validaroninput(this.id,'p-departamento','l-departamento')" name="categoria" id="categoria1" required>
                                               ...
                                               while ($linhas = $resultado->fetch(PDO::FETCH_ASSOC)) {
                                                   ...
                                                   <option value="<?php echo $linhas['idcategoria']; ?>"><?php echo $linhas['nomeCategoria']; ?></option>
                                                   <?php
                                               }
                                               ?>
                                           </select>
                                           <p class="invisivel text-danger invalido" id="p-categoria1">
                                           </p>
                                           <label class="label-validar invisivel" id="l-categoria1"></label>
                                        </div>       
                                    </div>
                                    <div class="col-md conteiner-novo" style="padding-left: 0px" >
                                        <div class="form-group" style="" id="novaCategoria">
                                            <label class="invisivel" for="categoria" >Nova Categoria</label>
                                            <div class="input-group">
                                                <input type="button" id="novaCategoria" class="btn btn-primary" style="border-top-left-radius:0;  border-bottom-left-radius: 0;" value="Criar Nova" onclick=""  data-toggle="modal" data-target="#modal">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="quantidade" value="" id="quantidade" placeholder="Quantidade" required>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md conteiner-novo" style="padding-left: 0px" >
                                        <div class="form-group" style="" id="novoFornecedor">
                                            ...
                                            <div class="input-group">
                                                <input type="button" value="Criar Novo" id="novaCategoria" class="btn btn-primary" style="border-top-left-radius:0;  border-bottom-left-radius: 0;" onclick=""  data-toggle="modal" data-target="#modal2">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input type="submit" value="Cadastrar" class="btn btn-success btn-block" name="btn" id="btn-cadastrar">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
