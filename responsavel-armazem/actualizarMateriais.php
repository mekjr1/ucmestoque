...
<html lang="pt-PT">
    <head>
        ...
        <title>Actualizar materiais - UCM Estoque</title>        
        <link rel="icon" href="../img/favicon.png">

        <!-- mobile fast/ estilo para media query -->
        <link href="../css/responsavel-armazem/mobile-first/mobile-first-responsavel-armazem-actualizar-materiais.css" rel="stylesheet">
        ...
        <!-- estilo para pagina -->
        <link href="../css/responsavel-armazem/responsavel-armazem-actualizar-materiais.css" rel="stylesheet">
                        ...
                        <div id="tabela">
                            <table class="table table-responsive  table-hover" id="tabela1">
                                ...
                                $select = "SELECT material.idmaterial,material.nomeMaterial, material.quantidade,material.dataEntrada, material.qtdSaida, material.qtdEstoque, categorias.nomeCategoria, fornecedores.nomeEmpresa
                                            FROM ((material INNER JOIN categorias on categorias.idcategoria=material.categoria_idcategoria) INNER JOIN fornecedores on fornecedores.idfornecedor=material.fornecedor_idfornecedor) where estado='aprovada'";
                                ...
                                while ($linhas = $resultado->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="actualizar.php?id=<?php echo $linhas ['idmaterial']; ?>"><i class="fa fa-edit" style="font-size: 20px; margin-right:10px; "></i></a>
