...
<title>Estoque de materiais - UCM Estoque</title>        
<link rel="icon" href="../img/favicon.png">

<!-- mobile fast/ estilo para media query -->
<link href="../css/responsavel-armazem/mobile-first/mobile-first-responsavel-armazem-estoque-materiais.css" rel="stylesheet">
...
<!-- estilo para pagina -->
<link href="../css/responsavel-armazem/responsavel-armazem-estoque-materiais.css" rel="stylesheet">
...
<main role="main" class="col-md-10 ml-auto col-xl-10 col-lg-10">
    ...
    <section class="mx-4 pt-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Estoque de materiais</h1>
        </div>
        <?php
        ...
        <div id="tabela">
            <table class="table table-responsive  table-hover" id="tabela1">
                ...
                <tbody>
                    <?php
                    $select = "SELECT material.idmaterial,material.nomeMaterial, material.quantidade,material.dataEntrada, material.qtdSaida, material.qtdEstoque, categorias.nomeCategoria, fornecedores.nomeEmpresa
    FROM ((material INNER JOIN categorias on categorias.idcategoria=material.categoria_idcategoria) INNER JOIN fornecedores on fornecedores.idfornecedor=material.fornecedor_idfornecedor) where estado='Atendida'";
                    ...
                    while ($linhas = $resultado->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        <tr>
                            <th scope="row">00<?php echo $linhas['idmaterial']; ?></th>
                            <td><?php echo $linhas['nomeMaterial']; ?></td>
                            <td><?php echo $linhas['nomeCategoria']; ?></td>
                            <td><?php echo $linhas['quantidade']; ?></td>
                            <td><?php echo $linhas['dataEntrada']; ?></td>
                            <td><?php echo $linhas['qtdSaida']; ?></td>
                            <td><?php echo $linhas['qtdEstoque']; ?></td>
                            <td><?php echo $linhas['nomeEmpresa']; ?></td>
        ...
        <div class="form-row" >
            <div class="col-md-3">
                <div class="form-group" style="">
                    <button type="submit" data-toggle="modal" data-target="#modal"  class="btn btn-info"  id="btn-fornecedor">Listar Fornecedores</button>
                </div>
            </div>  
            ...
            <div class="modal  fade" id="modal" tabindex="-1" role="dialog">
                <div class="modal-dialog modal-lg" role="document" style="margin-top: 90px;margin-let: 500px;margin-right:270px;">
                    <div class="modal-content">
                        <div class="modal-header">
                            <span class="text-muted ma" id="modaltexto"><h3>Sistma de Gestao de Estoque UCM-Estoque</h3> 
                            </span>
                        ...
                        <div class="modal-body" >
                            ...
                            <form id="Cad-departamento" method="post" action="php/">
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <input type="hidden" name="saida" value="">
                                        <h4>Lista de Forncedores</h4>        
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                while ($linhas = $resultado_forn->fetch(PDO::FETCH_ASSOC)) {
                                                    ?>

                                                    <tr>
                                                        <td><?php echo $linhas['nomeEmpresa']; ?></td>
                                                        <td><?php echo $linhas['email']; ?></td>
                                                        <td><?php echo $linhas['celular']; ?></td>
                                                        <td><?php echo $linhas['endereco']; ?></td>
                                                        <td>
                                                            <a href="EditarForncedore.php?id=<?php echo $linhas['idfornecedor'];?>" > <i class="fa fa-edit" style="font-size: 20px"></i></a>
                                                            <a href="ApagarFornecedor.php?id=<?php echo $linhas['idfornecedor'];?>"> <i class="fa fa-trash-alt" style="font-size: 20px; color: red"></i></a>
                                                        </td>
                                                    </tr>
