                ...
                <main role="main" class="col-md-10 ml-auto col-xl-10 col-lg-10">
                    ...
                    <section class="mx-4 pt-4">
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                            <h1 class="h2">Editar dados de materiais</h1>
                        </div>
                         <?php
                        ...
                        <div id="formulario-adicionar-materiais">
                            <form role="form" class="needs-validation cadastro" novalidate action="php/phpEditarMaterial.php" method="post">
                                ...
                                <div class="form-row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nomeMaterial" value="<?php echo $linhas ['nomeMaterial'];?>" id="nomeMaterial" placeholder="Nome do Material" required>
                                    ...
                                    <div class="col-md conteiner-novo" style="padding-left: 0px" >
                                        <div class="form-group" style="" id="novaCategoria">
                                            <label for="categoria">Nova Categoria<strong class="text-danger"></strong></label>
                                            <div class="input-group">
                                                <button type="button" id="novaCategoria" class="btn btn-primary" style="border-top-left-radius:0;  border-bottom-left-radius: 0;" onclick=""  data-toggle="modal" data-target="#modal">
                                                    <i class="fas fa-envelope"> </i>Criar Nova
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $linhas['quantidade'];?>" id="quantidade" name="quantidade" placeholder="Quantidade" required>
                                            <div class="invalid-feedback">
                                ...
                                <div class="form-row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input type="submit" value="Actualizar" class="btn btn-success btn-block" name="btn-cadastar" id="btn-cadastrar">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
