...
<html lang="pt-PT">
    <head>
        ...
        <title>Editar Fornecedor - UCM Estoque</title>        
                ...
                <main role="main" class="col-md-10 ml-auto col-xl-10 col-lg-10">
                    ...
                    <section class="mx-4 pt-4">
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                            <h1 class="h2 animated wobble">Editar Dados de Fornecedor</h1>
                        </div>
                        ...
                        <div id="formulario-adicionar-materiais">
                            <form role="form" class="needs-validation cadastro animated bounceIn" novalidate action="php/editarFornecedor.php" method="post">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="nomeEmpresa" value="<?php echo $linhas['nomeEmpresa'];?>" id="nomeempresa" required autocomplete="off" class="form-control" placeholder="Informe o nome da da empresa">
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <input type="email" name="email" value="<?php echo $linhas['email'];?>" id="email" autocomplete="off" class="form-control" placeholder="exemplo@email.com">
                                        </div>
                                    ...
                                    <div class="col-md-12" >
                                        <div class="form-group" style="padding-bottom:0px; margin-bottom: 0px;">
                                            ...
                                            <input type="tel" class="form-control validar" value="<?php echo $linhas['celular'];?>" name="celular" value=""  id="numero-telefone" placeholder="exemplo: 840000000" autocomplete="off" pattern="^8[24567]{1}[0-9]{7}">
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="localizacao" value="<?php echo $linhas['endereco'];?>" id="localizacao" autocomplete="off" class="form-control" placeholder="AV./RUA xxxxxxxxxx">
                                        </div>
