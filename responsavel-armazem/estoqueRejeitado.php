...
<html lang="pt-PT">
    <head>
        ...
        <title>Estoque Rejeitado - UCM Estoque</title>        
...
<!--                                            <li class="nav-item">
                ...
                <main role="main" class="col-md-10 ml-auto col-xl-10 col-lg-10">
                    ...
                    <section class="mx-4 pt-4">
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                            <h1 class="h2">Estoque de Material Rejeitado </h1>
                        </div>
            <?php
            ...
            ?>
                        <div id="tabela">
                            <table class="display table table-responsive  table-hover" id="tabela1">
                                <thead class="thead-light">
                                    <tr>
                                        <th scope="col">#Codigo</th>
                                        <th scope="col">Nome do Material </th>
                                        <th scope="col">Categoria do Material</th>
                                        <th scope="col">Quantidade do Material</th>
                                        <th scope="col">Fornecedor do Material</th>
                    ...
                    FROM ((material INNER JOIN categorias on categorias.idcategoria=material.categoria_idcategoria) INNER JOIN fornecedores on fornecedores.idfornecedor=material.fornecedor_idfornecedor)where estado='rejeitado'";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                 <a href="editarMaterial.php?id=<?php echo $linhas['idmaterial']; ?>"  class="btn btn-primary a-btn-slide-text">
