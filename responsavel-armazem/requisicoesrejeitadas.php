...
<html lang="pt-PT">
    <head>
        ...
        <link href="../css/responsavel-armazem/mobile-first/mobile-first-responsavel-armazem-requisicoes-rejeitadas.css" rel="stylesheet">
        ...
        <!-- estilo para pagina -->
        <link href="../css/responsavel-armazem/responsavel-armazem-requisicoes-rejeitadas.css" rel="stylesheet">
                        ...
                        <div id="tabela">
                            <table class="table table-responsive  table-hover" id="tabela1">
                                <thead class="thead-light">
                                    <tr>
                                       <th scope="col">#ID</th>
                                        ...
                                        <th scope="col">Comentario Requisitante</th>
                                         <th scope="col">Comentário Gestor</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <?php
                                $select = "SELECT requisicoes.idrequisicao, requisicoes.quantidade, requisicoes.data, requisicoes.estado, requisicoes.comentario, requisicoes.comentarioGestor, material.nomeMaterial "
                                        . "from requisicoes INNER JOIN material on material.idmaterial=requisicoes.fk_material where  requisicoes.estado='Rejeitada'";
