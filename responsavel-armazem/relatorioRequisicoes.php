...
<html lang="pt-PT">
    <head>
        ...
        <title>Relatóriode requisições - UCM Estoque</title>        
        <link rel="icon" href="../img/favicon.png">

        <!-- mobile fast/ estilo para media query -->
        <link href="../css/responsavel-armazem/mobile-first/mobile-first-responsavel-armazem-relatorio-requisicoes.css" rel="stylesheet">
        ...
        <!-- estilo para pagina -->
        <link href="../css/responsavel-armazem/responsavel-armazem-relatorio-requisicoes.css" rel="stylesheet">
