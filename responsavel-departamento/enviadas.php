...
<html lang="pt-PT">
    <head>
        ...
        <title>Requisições enviadas - UCM Estoque</title>        
        <link rel="icon" href="../img/favicon.png">

        <!-- mobile fast/ estilo para media query -->
        <link href="../css/responsavel-departamento/mobile-first/mobile-first-responsavel-departamento-requisicoes-enviadas.css" rel="stylesheet">
        ...
        <!-- estilo para pagina -->
        <link href="../css/responsavel-departamento/responsavel-departamento-requisicoes-enviadas.css" rel="stylesheet">
                ...
                <main role="main" class="col-md-10 ml-auto col-xl-10 col-lg-10">
                    ...
                    <section class="mx-4 pt-4">
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                            <h1 class="h2">Requisições enviadas</h1>
                        </div>
                            ...
                            <table class="table table-responsive  table-hover" id="tabela1">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col">Estado da Requisicao</th>
                                        <th scope="col">comentario </th>
                                        <th scope="col">Acçõs</th>
                                    </tr>
                                </thead>
                                   <tbody>
                                <?php
                                $select = "SELECT requisicoes.idrequisicao, requisicoes.quantidade, requisicoes.data, requisicoes.estado, requisicoes.comentario, requisicoes.comentarioGestor, material.nomeMaterial "
                                        . "from requisicoes INNER JOIN material on material.idmaterial=requisicoes.fk_material where requisicoes.estado='Nova' AND requisicoes.fk_us='".$_SESSION['id']."'";
                                ...
                                while ($linhas = $resultado->fetch(PDO::FETCH_ASSOC)) {
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo $linhas ['idrequisicao'];?>" data-toggle="modal" data-target="#modal"><i class="fa fa-trash-alt" style="color: red; font-size: 20px"></i></a>
                                                                ...
                                                                <div class="modal-body" >
                                                                    ...
                                                                    <form id="Cad-departamento" method="post" action="php/deletar.php">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="submit" name="Apagar" class="btn btn-primary">Confirmar</button>
