...
<html lang="pt-PT">
    <head>
        ...
        <link href="../css/responsavel-departamento/mobile-first/mobile-first-responsavel-departamento-inicio.css" rel="stylesheet">
        ...
        <!-- estilo para pagina -->
        <link href="../css/responsavel-departamento/responsavel-departamento-inicio.css" rel="stylesheet">
    ...
    <body>
        ...
        <div class="container-fluid pl-0 pr-0">
            <div class="row w-100 mr-0 ml-0 animated jello">
            <nav class="col-md-2 d-md-block bg-light sidebar collapse bd-links navcollapse" id="siderbar-nav">
                ...
                <main role="main" class="col-md-10 ml-auto col-xl-10 col-lg-10">
                    ...
                    <section>
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    ...
                                    <div class="carousel-caption d-none d-md-block animated rollIn">
                                        <h1>Requisitar materiais</h1>
                                        <a class="btn btn-lg btn-success" href="responsavel-departamento-requisitar-materiais.html">Prosseguir</a>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    ...
                                    <div class="carousel-caption d-none d-md-block animated swing">
                                        <h1>Requisições aprovadas</h1>
                                        <a class="btn btn-lg btn-success" href="responsavel-departamento-requisicoes-aprovadas.html">Prosseguir</a>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="slide-icon">
                                    ...
                                    <div class="carousel-caption d-none d-md-block animated rubberBand">
                                        <h1>Requisições rejeitadas</h1>
                                        <a class="btn btn-lg btn-success" href="responsavel-departamento-requisicoes-rejeitadas.html">Prosseguir</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="saudacao">
                            <p class="lead">
                                <span id="saudacao-periodo">Seja Bem Vindo</span> 
                                <span id="saudacao-usuario-online"> <?php if(isset($_SESSION['unome'])){
                                    echo $_SESSION['unome'];
                                }?></span>
                            </p>
                            <p class="lead">Já podes iniciar as requisições de materiais pelo <strong>UCM-Estoque</strong></p>
                        </div>
                    </section>
