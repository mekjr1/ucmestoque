...
<html lang="pt-PT">
    <head>
        ...
        <link href="../css/responsavel-departamento/mobile-first/mobile-first-responsavel-departamento-requisicoes-aprovadas.css" rel="stylesheet">
        ...
        <!-- estilo para pagina -->
        <link href="../css/responsavel-departamento/responsavel-departamento-requisicoes-aprovadas.css" rel="stylesheet">
                    ...
                    <section class="mx-4 pt-4">
                        ...
                        <div id="tabela">
                            <table class="table table-responsive  table-hover" id="tabela1">
                                ...
                                <tbody>
                                <?php
                                $select = "SELECT requisicoes.idrequisicao, requisicoes.quantidade, requisicoes.data, requisicoes.estado, requisicoes.comentario,requisicoes.fk_us, requisicoes.comentarioGestor, material.nomeMaterial"
                                        . " from requisicoes INNER JOIN material on material.idmaterial=requisicoes.fk_material where requisicoes.estado='Aprovada' AND requisicoes.fk_us='".$_SESSION['id']."'";
