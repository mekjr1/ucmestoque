...
<html lang="pt-PT">
    <head>
        ...
        <title>Novas entradas - UCM Estoque</title>        
        <link rel="icon" href="../img/favicon.png">

        <!-- mobile fast/ estilo para media query -->
        <link href="../css/administrador-faculdade/mobile-first/mobile-first-administrador-faculdade-estoque-materiais.css" rel="stylesheet">
        ...
        <!-- estilo para pagina -->
        <link href="../css/administrador-faculdade/administrador-faculdade-estoque-materiais.css" rel="stylesheet">
        ...
        <div class="container-fluid pl-0 pr-0">
            <div class="row w-100 mr-0 ml-0">
                    ...
                    <div class="sidebar-sticky ">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item ">
                             ...
                             <li class="nav-item ">
                                 <a class="nav-link active" href="novasEntradas.php">
                ...
                <main role="main" class="col-md-10 ml-auto col-xl-10 col-lg-10">
                    ...
                    <tbody>
                    <?php 
                    $select = "SELECT material.idmaterial,material.nomeMaterial,material.novaqtd, material.quantidade,material.dataEntrada, material.qtdSaida, material.qtdEstoque, categorias.nomeCategoria, fornecedores.nomeEmpresa
                    FROM ((material INNER JOIN categorias on categorias.idcategoria=material.categoria_idcategoria) INNER JOIN fornecedores on fornecedores.idfornecedor=material.fornecedor_idfornecedor) where estado ='novo'";
                    ...
                    while($linhas=$resultado->fetch(PDO::FETCH_ASSOC)){ ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $linhas['novaqtd'];?></td>
                                        <td><?php echo $linhas['dataEntrada'];?></td>
                                        <td><?php echo $linhas['nomeEmpresa'];?></td>
                                        <td>
                                            <div class="input-group">
                                                 <a href="id=<?php echo $linhas['idmaterial']; ?>" data-toggle="modal" data-target="#modal" class="btn btn-primary a-btn-slide-text">
                                                    ...
                                                    <div class="modal-dialog" role="document" style="margin-top: 90px;margin-let: 500px;margin-right:270px;">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body" >
                                                                ...
                                                                <form id="Cad-departamento" method="post" action="FuncoesPhp/aprovar.php">
                                                                    <div class="form-row">
                                                                        <div class="col-md-12">
                                                                            <input type="hidden" name="aprovar" value="<?php echo $linhas ['idmaterial']; ?>">
                                                                            <h5 class="modal-title" style="text-align:center; margin-bottom: 25px;">
                                                                                Deseja realmente Aprovar?<?php echo $linhas ['idmaterial']; ?>
                                                                            </h5>    
                                        ...
                                        <!--Fimm do  modal e td-->
                                         <td>
                                            <div class="input-group">
                                                <a href="id=<?php echo $linhas['idmaterial']; ?>" data-toggle="modal" data-target="#modal1" class="btn btn-danger a-btn-slide-text">
                                                    ...
                                                    <div class="modal-dialog" role="document" style="margin-top: 90px;margin-let: 500px;margin-right:270px;">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body" >
                                                                ...
                                                                <form id="Cad-departamento" method="post" action="FuncoesPhp/rejeitar.php">
                                                                    <div class="form-row">
                                                                        <div class="col-md-12">
                                                                            <input type="hidden" name="rejeitar" value="<?php echo $linhas ['idmaterial']; ?>">
                                                                            <h5 class="modal-title" style="text-align:center; margin-bottom: 25px;">
                                                                                Deseja realmente Rejeitar?<?php echo $linhas ['idmaterial']; ?>
                                                                            </h5>    
