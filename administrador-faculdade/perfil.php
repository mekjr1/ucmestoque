...
<html lang="pt-PT">
    <head>
        ...
        <link href="../css/administrador-faculdade/mobile-first/mobile-first-administrador-faculdade-alterar-perfil.css" rel="stylesheet">
        ...
        <!-- estilo para pagina -->
        <link href="../css/administrador-faculdade/administrador-faculdade-alterar-perfil.css" rel="stylesheet">
    ...
    <body>
        <header>
            ...
            <nav class="navbar navbar-expand-md fixed-top navbar-dark">
                <a class="navbar-brand pt-0 pb-0" href="administrador-faculdade-inicio.html">
                ...
                <nav class="col-md-2 d-md-block bg-light sidebar collapse bd-links navcollapse" id="siderbar-nav">
                    <div class="sidebar-sticky ">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="relatorioRequisicoes.phpl">
                                    <i class="fas fa-file-alt"></i>
                ...
                <main role="main" class="col-md-10 ml-auto col-xl-10 col-lg-10">
                    ...
                    <section class="mx-4 pt-4">
                        ...
                        <div id="formulario-alterar-perfil">
                            <form role="form" class="needs-validation cadastro" novalidate action="FuncoesPhp/EditarPerfil.php" method="post">
                                <div class="form-row">
                                    <input type="hidden" name="id" value="<?php echo $linhas['idUsuario'];?>">
                                    <div class="col-md">
                                        <div class="form-group">
                                            <label for="email">Email</label>
                                            <input type="email" class="form-control" name="email" value="<?php echo $linhas['email'];?>" id="email" placeholder="exemplo@email.com" autocomplete="off" required>
